...
@php
$iconlar = [
    'bi-droplet-half'     => 'Zeytinyağı / Sirke',
    'bi-basket'           => 'Peynir / Şarküteri',
    'bi-flower1'          => 'Bal / Reçel',
    'bi-tree'             => 'Kuruyemiş / Kuru Meyve',
    'bi-fire'             => 'Baharat / Sos',
    'bi-cup-hot'          => 'Kahve / Çay',
    'bi-egg-fried'        => 'Kahvaltılık',
    'bi-cookie'           => 'Tatlı / Atıştırmalık',
    'bi-cup-straw'        => 'İçecek',
    'bi-award'            => 'Coğrafi İşaretli / Ödüllü',
    'bi-gem'              => 'Premium / Lüks',
    'bi-shield-check'     => 'Doğal / Katkısız',
    'bi-box-seam'         => 'Hediye Kutusu',
    'bi-tags'             => 'Genel',
];
    ...
    <div class="row">
        <div class="col-lg-6">
            <div class="card-a">
                ...
                <label><i class="bi bi-translate"></i> Category Name (EN)</label>
                <input name="en_name" value="{{ old('en_name', data_get($category->ceviri, 'en.name')) }}" placeholder="İngilizce ad — boşsa Türkçesi gösterilir">
