...
class Cart
{
    ...
    /**
     * Kargo ücreti — panelden girilen tek değer (Ayarlar > Kargo).
     *
     * Ücretsiz kargo EŞİĞİ bilinçli olarak YOK: müşteri "şu tutarın üstü bedava"
     * vaadini kaldırmak istedi. Geri istenirse burada `kargo_bedava_limit`
     * ayarına bakıp 0 döndürmek ve panele alanı geri eklemek yeterli.
     */
